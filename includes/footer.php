...
<footer class="bg-ink text-paper py-14" role="contentinfo">
  <div class="max-w-6xl mx-auto px-6">
    <div class="grid md:grid-cols-3 gap-10 mb-10">
      <div>
        <div class="flex items-center gap-2 mb-4">
          <img src="/assets/images/zabida_logo.png" alt="ZABIDA logo" width="48" height="48" class="h-9 w-auto object-contain" onerror="this.style.display='none'" loading="lazy">
      ...
      <div>
        ...
        <ul class="space-y-2 text-sm text-paper/70">
          <li><a href="/index.php#about" class="hover:text-gold">About</a></li>
          <li><a href="/index.php#partners" class="hover:text-gold">Member NGOs</a></li>
      ...
      <div>
        ...
        <ul class="space-y-2 text-sm text-paper/70">
          ...
          <li><a href="https://www.facebook.com/zabida.org" target="_blank" rel="noopener noreferrer" class="hover:text-gold">facebook.com/zabida.org</a></li>
    ...
    <div class="border-t border-paper/15 pt-8 text-center text-sm text-paper/40 font-mono">
      &copy; <span id="current-year"></span> ZABIDA &mdash; Empowering Communities For Human Security
    </div>
  </div>
</footer>
